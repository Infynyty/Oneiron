...
public class ArmorListener implements Listener {
        ...
        if(shift){
            ...
            if(newArmorType != null){
                ...
                if(newArmorType.equals(ArmorType.HELMET) && (equipping == isAirOrNull(e.getWhoClicked().getInventory().getHelmet())) || newArmorType.equals(ArmorType.CHESTPLATE) && (equipping ? isAirOrNull(e.getWhoClicked().getInventory().getChestplate()) : !isAirOrNull(e.getWhoClicked().getInventory().getChestplate())) || newArmorType.equals(ArmorType.LEGGINGS) && (equipping ? isAirOrNull(e.getWhoClicked().getInventory().getLeggings()) : !isAirOrNull(e.getWhoClicked().getInventory().getLeggings())) || newArmorType.equals(ArmorType.BOOTS) && (equipping ? isAirOrNull(e.getWhoClicked().getInventory().getBoots()) : !isAirOrNull(e.getWhoClicked().getInventory().getBoots()))){
                    ChangeOneironArmorEvent armorEquipEvent = new ChangeOneironArmorEvent((Player) e.getWhoClicked(), ChangeOneironArmorEvent.EquipMethod.SHIFT_CLICK, newArmorType, equipping ? null : e.getCurrentItem(), equipping ? e.getCurrentItem() : null);
            ...
            if(newArmorType != null && e.getRawSlot() == newArmorType.getSlot()){
                ChangeOneironArmorEvent.EquipMethod method = ChangeOneironArmorEvent.EquipMethod.PICK_DROP;
                if(e.getAction().equals(InventoryAction.HOTBAR_SWAP) || numberkey) method = ChangeOneironArmorEvent.EquipMethod.HOTBAR_SWAP;
                ChangeOneironArmorEvent armorEquipEvent = new ChangeOneironArmorEvent((Player) e.getWhoClicked(), method, newArmorType, oldArmorPiece, newArmorPiece);
                Bukkit.getServer().getPluginManager().callEvent(armorEquipEvent);
                if(armorEquipEvent.isCancelled()){
                    e.setCancelled(true);
                }
        ...
        if(e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK){
            ...
            if(newArmorType != null){
                if(newArmorType.equals(ArmorType.HELMET) && isAirOrNull(e.getPlayer().getInventory().getHelmet()) || newArmorType.equals(ArmorType.CHESTPLATE) && isAirOrNull(e.getPlayer().getInventory().getChestplate()) || newArmorType.equals(ArmorType.LEGGINGS) && isAirOrNull(e.getPlayer().getInventory().getLeggings()) || newArmorType.equals(ArmorType.BOOTS) && isAirOrNull(e.getPlayer().getInventory().getBoots())){
                    ChangeOneironArmorEvent armorEquipEvent = new ChangeOneironArmorEvent(e.getPlayer(), ChangeOneironArmorEvent.EquipMethod.HOTBAR, ArmorType.matchType(e.getItem()), null, e.getItem());
                    Bukkit.getServer().getPluginManager().callEvent(armorEquipEvent);
                    if(armorEquipEvent.isCancelled()){
                        e.setCancelled(true);
                    }
    ...
    public void inventoryDrag(InventoryDragEvent event){
        ...
        if(type != null && type.getSlot() == event.getRawSlots().stream().findFirst().orElse(0)){
            ChangeOneironArmorEvent armorEquipEvent = new ChangeOneironArmorEvent((Player) event.getWhoClicked(), ChangeOneironArmorEvent.EquipMethod.DRAG, type, null, event.getOldCursor());
            Bukkit.getServer().getPluginManager().callEvent(armorEquipEvent);
            if(armorEquipEvent.isCancelled()){
    ...
    public void itemBreakEvent(PlayerItemBreakEvent e){
        ...
        if(type != null){
            ...
            ChangeOneironArmorEvent armorEquipEvent = new ChangeOneironArmorEvent(p, ChangeOneironArmorEvent.EquipMethod.BROKE, type, e.getBrokenItem(), null);
            Bukkit.getServer().getPluginManager().callEvent(armorEquipEvent);
            if(armorEquipEvent.isCancelled()){
    ...
    public void playerDeathEvent(PlayerDeathEvent e){
        ...
        for(ItemStack i : p.getInventory().getArmorContents()){
            if(!isAirOrNull(i)){
                Bukkit.getServer().getPluginManager().callEvent(new ChangeOneironArmorEvent(p, ChangeOneironArmorEvent.EquipMethod.DEATH, ArmorType.matchType(i), i, null));
