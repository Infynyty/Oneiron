...
public class ChangeOneironArmorEvent extends PlayerEvent implements Cancellable {
     ...
     */
    public ChangeOneironArmorEvent(final Player player, final EquipMethod equipType, final ArmorType type, final ItemStack oldArmorPiece, final ItemStack newArmorPiece){
        super(player);
